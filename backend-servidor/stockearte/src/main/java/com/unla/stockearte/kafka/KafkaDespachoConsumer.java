...
@Service
public class KafkaDespachoConsumer {

	@Autowired
    private OrdenDeCompraRepository ordenDeCompraRepository;
	
	private static final Logger logger = LoggerFactory.getLogger(KafkaDespachoConsumer.class);

    private final ObjectMapper objectMapper = new ObjectMapper();

    @KafkaListener(topics = "despacho", groupId = "stockearte-group")
